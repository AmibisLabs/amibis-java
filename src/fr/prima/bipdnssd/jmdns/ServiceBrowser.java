...
import fr.prima.bipdnssd.interf.ServiceInformation;

public class ServiceBrowser
implements fr.prima.bipdnssd.interf.ServiceBrowser, ServiceListener {
    ...
    private ServiceInformation infoOf(javax.jmdns.ServiceEvent event) {
        return new fr.prima.bipdnssd.jmdns.ServiceInformation(
                event.getType(),
                event.getName());
    }

    private ServiceInformation fullInfoOf(javax.jmdns.ServiceEvent event) {
        return new fr.prima.bipdnssd.jmdns.ServiceInformation(event.getInfo());
