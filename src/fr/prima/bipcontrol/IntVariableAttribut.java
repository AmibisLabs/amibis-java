...
/**
 * Group an integer, and a variable description for bip service.
 * Enable to maintain easily the value in the integer and the value in the description.
 * For that purpose, the interger is accessed through methods as getIntValue, SetIntValue.
 * 
