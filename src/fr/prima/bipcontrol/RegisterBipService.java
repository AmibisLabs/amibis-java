...
/** 
 * Register a Bip Service on DNS-SD;
 * The service is registered with the type "_bip._tcp". 
 * The service is automatically renamed, if a service with the same name already exists.
 * The name obtained finally kept after the registration is available through this object (getRegisteredName()).
...
public class RegisterBipService implements com.apple.dnssd.RegisterListener {
    ...
    /** Enables to change the service name. 
     * Must be used before registration :
     * before a call to the method register */
