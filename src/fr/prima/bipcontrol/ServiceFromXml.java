...
public class ServiceFromXml extends fr.prima.bipcontrol.ControlServer{
     
    /*ServiceFromXml(String path_ontology, String basefile_ontology, String file_name){
        super();
        GenerateXMLDescr gxd = new GenerateXMLDescr(path_ontology, basefile_ontology);        
        Document doc = gxd.loadBaseDocument(file_name);
