...
/** Stores In/Output Description.
 * The in/output description is composed of a tcp port, udp port, 
 * a description, a description for the format, a kind 
 * (input, output, or in_output) and a object ComTools that can provides the
 * connected peer.
 * <br>
...
public class InOutputAttribut extends Attribut {
    ...
    /** Defines the TCP port value.
     * Used by the ControlClient when it receives an in/output description 
     * @param tcp the port number */
    public void setTcpPort(int tcp) {
        tcpPort = tcp;
    }
    /** Defines the UDP port value.
     * Used by the ControlClient when it receives an in/output description 
