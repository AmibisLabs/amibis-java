...
/**
 * Wait for a BIP service with a particular name.
 * It can test other properties by implementing the interface 
 * {@link fr.prima.bipcontrol.WaitForTheGoodBipService}.
 * When a service is found with a good name, and it is 
 * resolved then the method {@link fr.prima.bipcontrol.WaitForTheGoodBipService#isAGoodService(BipService)} of the object implementing 
 * the WaitForTheGoodBipService is called on the data about this service.
 * The service is kept or not according to the result of this method.
 * <br>
 * Use :
 * <ul>
 *   <li>Create a new instance of the object SearchBipService, with the name to find.
 *   </li>
 *   <li>Start the research : {@link SearchBipService#startSearch(WaitForTheGoodBipService)}
 *   </li>
 *   <li>wait for the service : the service is found when 
 *   {@link SearchBipService#isResolved()} returns true.
 *   </li>
 * </ul>  
 * <br>
 * Note : This class is used by {@link fr.prima.bipcontrol.WaitForBipServices} 
 * that enables to launch several service research, and to wait that they are all found.
 * 
