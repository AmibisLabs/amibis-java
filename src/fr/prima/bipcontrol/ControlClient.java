...
/**
 * Communication with a control server of a BIP service.
 * Query data, store answer. Has a local copy of the data.
 * <br>
 * Use:
 * <ul><li> Creates a ControlClient instance
 * </li><li> Connect the control client to a control server
 * </li><li> query a global description of the service : then you have the 
 * names for all variables and in/outputs.
 * </li><li> you can do specific query on variable, or in/output 
 * </li></ul>
 * 
...
//         msg.getBufferAsString());
    ...
    private XmlMessage queryToServer(String request, boolean waitAnswer) {
        ...
        synchronized (answerEvent) {
            if (isConnected()) {
                int theMsgId = msgId++;
                String str = fr.prima.bipcom.MsgSocket.intTo8HexString(theMsgId);
