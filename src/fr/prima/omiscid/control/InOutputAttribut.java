...
public class InOutputAttribut extends Attribut {
     ...
     * connected peer. */
    private fr.prima.omiscid.com.ComTools comTool = null;
     ...
     * */
    public InOutputAttribut(String aName, fr.prima.omiscid.com.ComTools ct) {
        super(aName);
        comTool =ct;
    }
    /**
    ...
    public String generateLongDescription() {
        ...
        while (it.hasNext()) {
            str += "<peer>" + fr.prima.omiscid.com.MsgSocket.intTo8HexString(it.next().intValue()) + "</peer>";
        }
	 ...
	 */
    public void setComTool(fr.prima.omiscid.com.ComTools comTool){
    ...
    public Element createXmlElement(Document doc){
        ...
        if(!v.isEmpty()){
            ...
            while (it.hasNext()) {
                ...
                elt.setTextContent(fr.prima.omiscid.com.MsgSocket.intTo8HexString(it.next().intValue()));
	 ...
	 * @uml.property  name="comTool"
	 */
	public fr.prima.omiscid.com.ComTools getComTool() {
		return comTool;
	}
}
