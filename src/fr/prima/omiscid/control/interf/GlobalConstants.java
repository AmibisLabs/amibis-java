...
public final class GlobalConstants {
    ...
    public static final String channelTypeInputXMLTag = "input";
    public static final String channelTypeOutputXMLTag = "output";
    public static final String channelTypeInOutputXMLTag = "inoutput";
