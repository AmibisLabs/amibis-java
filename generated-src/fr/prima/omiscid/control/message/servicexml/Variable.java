...
import fr.prima.omiscid.control.message.servicexml.types.AccessType;
...
public class Variable implements java.io.Serializable {
     ...
     * Field _access
     */
    private fr.prima.omiscid.control.message.servicexml.types.AccessType _access;
    ...
    public Variable() 
     {
        super();
    } //-- fr.prima.omiscid.control.message.servicexml.Variable()
     ...
     */
    public fr.prima.omiscid.control.message.servicexml.types.AccessType getAccess()
    {
        return this._access;
    } //-- fr.prima.omiscid.control.message.servicexml.types.AccessType getAccess() 
     ...
     */
    public void setAccess(fr.prima.omiscid.control.message.servicexml.types.AccessType access)
    {
        this._access = access;
    } //-- void setAccess(fr.prima.omiscid.control.message.servicexml.types.AccessType) 
     ...
     * @return Variable
     */
    public static fr.prima.omiscid.control.message.servicexml.Variable unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.prima.omiscid.control.message.servicexml.Variable) Unmarshaller.unmarshal(fr.prima.omiscid.control.message.servicexml.Variable.class, reader);
    } //-- fr.prima.omiscid.control.message.servicexml.Variable unmarshal(java.io.Reader) 
