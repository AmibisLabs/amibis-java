...
public class VariableDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public VariableDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
        //-- _access
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(fr.prima.omiscid.control.message.servicexml.types.AccessType.class, "_access", "access", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Variable target = (Variable) object;
                    target.setAccess( (fr.prima.omiscid.control.message.servicexml.types.AccessType) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- fr.prima.omiscid.control.message.servicexml.VariableDescriptor()
    ...
    {
        return fr.prima.omiscid.control.message.servicexml.Variable.class;
