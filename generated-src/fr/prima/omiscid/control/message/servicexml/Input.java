 ...
 */
public class Input extends ConnectorType 
implements java.io.Serializable
{
    ...
    public Input() 
     {
        super();
    } //-- fr.prima.omiscid.control.message.servicexml.Input()
    ...
    public static fr.prima.omiscid.control.message.servicexml.ConnectorType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.prima.omiscid.control.message.servicexml.ConnectorType) Unmarshaller.unmarshal(fr.prima.omiscid.control.message.servicexml.Input.class, reader);
