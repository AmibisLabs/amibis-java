 ...
 */
public class Peers extends PeersType 
implements java.io.Serializable
{
    ...
    public Peers() 
     {
        super();
    } //-- fr.prima.omiscid.control.message.answer.Peers()
    ...
    public static fr.prima.omiscid.control.message.answer.PeersType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.prima.omiscid.control.message.answer.PeersType) Unmarshaller.unmarshal(fr.prima.omiscid.control.message.answer.Peers.class, reader);
