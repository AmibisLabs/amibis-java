 ...
 */
public class Lock extends CA_LockType 
implements java.io.Serializable
{
    ...
    public Lock() 
     {
        super();
    } //-- fr.prima.omiscid.control.message.answer.Lock()
    ...
    public static fr.prima.omiscid.control.message.answer.CA_LockType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.prima.omiscid.control.message.answer.CA_LockType) Unmarshaller.unmarshal(fr.prima.omiscid.control.message.answer.Lock.class, reader);
