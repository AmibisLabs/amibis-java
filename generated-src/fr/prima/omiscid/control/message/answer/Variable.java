 ...
 */
public class Variable extends CA_VariableType 
implements java.io.Serializable
{
    ...
    public Variable() 
     {
        super();
    } //-- fr.prima.omiscid.control.message.answer.Variable()
    ...
    public static fr.prima.omiscid.control.message.answer.CA_VariableType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.prima.omiscid.control.message.answer.CA_VariableType) Unmarshaller.unmarshal(fr.prima.omiscid.control.message.answer.Variable.class, reader);
