    ...
    public ControlEventDescriptor() 
     {
        ...
        //-- _items
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(fr.prima.omiscid.control.message.answer.ControlEventItem.class, "_items", (String)null, org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ControlEvent target = (ControlEvent) object;
                return target.getControlEventItem();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ControlEvent target = (ControlEvent) object;
                    target.addControlEventItem( (fr.prima.omiscid.control.message.answer.ControlEventItem) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new fr.prima.omiscid.control.message.answer.ControlEventItem();
            }
        };
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new fr.prima.omiscid.control.message.answer.ControlEventItemDescriptor());
