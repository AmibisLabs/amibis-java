 ...
 */
public class Input extends CA_InOutputType 
implements java.io.Serializable
{
    ...
    public Input() 
     {
        super();
    } //-- fr.prima.omiscid.control.message.answer.Input()
    ...
    public static fr.prima.omiscid.control.message.answer.CA_InOutputType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.prima.omiscid.control.message.answer.CA_InOutputType) Unmarshaller.unmarshal(fr.prima.omiscid.control.message.answer.Input.class, reader);
