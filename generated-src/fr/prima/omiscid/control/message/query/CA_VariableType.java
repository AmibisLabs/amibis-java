...
import fr.prima.omiscid.control.message.query.types.AccessType;
...
public class CA_VariableType implements java.io.Serializable {
     ...
     * Field _access
     */
    private fr.prima.omiscid.control.message.query.types.AccessType _access;
    ...
    public CA_VariableType() 
     {
        super();
    } //-- fr.prima.omiscid.control.message.query.CA_VariableType()
     ...
     */
    public fr.prima.omiscid.control.message.query.types.AccessType getAccess()
    {
        return this._access;
    } //-- fr.prima.omiscid.control.message.query.types.AccessType getAccess() 
     ...
     */
    public void setAccess(fr.prima.omiscid.control.message.query.types.AccessType access)
    {
        this._access = access;
    } //-- void setAccess(fr.prima.omiscid.control.message.query.types.AccessType) 
     ...
     */
    public static fr.prima.omiscid.control.message.query.CA_VariableType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.prima.omiscid.control.message.query.CA_VariableType) Unmarshaller.unmarshal(fr.prima.omiscid.control.message.query.CA_VariableType.class, reader);
    } //-- fr.prima.omiscid.control.message.query.CA_VariableType unmarshal(java.io.Reader) 
