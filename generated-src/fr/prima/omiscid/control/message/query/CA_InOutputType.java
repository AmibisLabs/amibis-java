...
public class CA_InOutputType implements java.io.Serializable {
     ...
     * Field _peers
     */
    private fr.prima.omiscid.control.message.query.Peers _peers;
    ...
    public CA_InOutputType() 
     {
        super();
    } //-- fr.prima.omiscid.control.message.query.CA_InOutputType()
     ...
     */
    public fr.prima.omiscid.control.message.query.Peers getPeers()
    {
        return this._peers;
    } //-- fr.prima.omiscid.control.message.query.Peers getPeers() 
     ...
     */
    public void setPeers(fr.prima.omiscid.control.message.query.Peers peers)
    {
        this._peers = peers;
    } //-- void setPeers(fr.prima.omiscid.control.message.query.Peers) 
     ...
     */
    public static fr.prima.omiscid.control.message.query.CA_InOutputType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.prima.omiscid.control.message.query.CA_InOutputType) Unmarshaller.unmarshal(fr.prima.omiscid.control.message.query.CA_InOutputType.class, reader);
    } //-- fr.prima.omiscid.control.message.query.CA_InOutputType unmarshal(java.io.Reader) 
