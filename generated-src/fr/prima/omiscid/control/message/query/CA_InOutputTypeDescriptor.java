...
public class CA_InOutputTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CA_InOutputTypeDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
        //-- _peers
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(fr.prima.omiscid.control.message.query.Peers.class, "_peers", "peers", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    CA_InOutputType target = (CA_InOutputType) object;
                    target.setPeers( (fr.prima.omiscid.control.message.query.Peers) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new fr.prima.omiscid.control.message.query.Peers();
            }
        };
        desc.setHandler(handler);
        desc.setMultivalued(false);
        ...
        desc.setValidator(fieldValidator);
    } //-- fr.prima.omiscid.control.message.query.CA_InOutputTypeDescriptor()
    ...
    {
        return fr.prima.omiscid.control.message.query.CA_InOutputType.class;
