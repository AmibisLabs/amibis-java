...
implements java.io.Serializable
{
    ...
    public Peers() 
     {
        super();
    } //-- fr.prima.omiscid.control.message.query.Peers()
    ...
    public static fr.prima.omiscid.control.message.query.PeersType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.prima.omiscid.control.message.query.PeersType) Unmarshaller.unmarshal(fr.prima.omiscid.control.message.query.Peers.class, reader);
