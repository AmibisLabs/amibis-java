...
/**
 * Class ConnectChoiceDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ConnectChoiceDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ConnectChoiceDescriptor() 
     {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ConnectChoice target = (ConnectChoice) object;
                if(!target.hasTcp())
                    return null;
        ...
        desc.setValidator(fieldValidator);
    } //-- fr.prima.omiscid.control.message.query.ConnectChoiceDescriptor()
    ...
    {
        return fr.prima.omiscid.control.message.query.ConnectChoice.class;
