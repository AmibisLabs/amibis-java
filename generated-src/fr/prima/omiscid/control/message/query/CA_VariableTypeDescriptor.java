...
/**
 * Class CA_VariableTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class CA_VariableTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CA_VariableTypeDescriptor() 
     {
        super();
        xmlName = "CA_VariableType";
        ...
        desc.setValidator(fieldValidator);
        //-- _access
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(fr.prima.omiscid.control.message.query.types.AccessType.class, "_access", "access", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    CA_VariableType target = (CA_VariableType) object;
                    target.setAccess( (fr.prima.omiscid.control.message.query.types.AccessType) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(fr.prima.omiscid.control.message.query.types.AccessType.class, handler);
        desc.setImmutable(true);
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setValidator(fieldValidator);
    } //-- fr.prima.omiscid.control.message.query.CA_VariableTypeDescriptor()
    ...
    {
        return fr.prima.omiscid.control.message.query.CA_VariableType.class;
